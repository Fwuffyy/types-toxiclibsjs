...
declare class Vec2D {
    ...
    public interpolateTo(v: Vec2D, f: number, s: Interpolation2D.InterpolatorT): Vec2D;
     ...
     */
    public interpolateToSelf(v: Vec2D, f: number, s: Interpolation2D.InterpolatorT): this;
...
declare class Vec3D {
    ...
    public interpolateTo(v: Vec3D, f: number, s: Interpolation2D.InterpolatorT): Vec3D;

    public interpolateToSelf(v: Vec3D, f: number, s: Interpolation2D.InterpolatorT): this;
